# Django settings for buzzter project.

DEBUG = True
TEMPLATE_DEBUG = DEBUG
import os

#To use unipath uncomment this lines
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Buzzter',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': 'BuzzterAdmin',
        'PASSWORD': 'WHo7_@yj.TK-9',
...
SECRET_KEY = 'b7ch_xcwd^az4f^nod)9uf)4$_!^r@^74*c5=91q#-ip3v=o6v'
